...
public class FindNearestPolyResult {
	private var nearestRef:Number;
	private var nearestPos:Array;

	public function FindNearestPolyResult(nearestRef:Number, nearestPos:Array) {
		this.nearestRef = nearestRef;
		this.nearestPos = nearestPos;
	}

	/** Returns the reference id of the nearest polygon. */
	public function getNearestRef():Number {
		return nearestRef;
	}
