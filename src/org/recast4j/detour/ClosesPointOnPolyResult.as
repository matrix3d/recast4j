...
public class ClosesPointOnPolyResult {
	...
	private var posOverPoly:Boolean;
	private var closest:Array;

	public function ClosesPointOnPolyResult(posOverPoly:Boolean, closest:Array) {
		this.posOverPoly = posOverPoly;
		this.closest = closest;
	}

	/** Returns true if the position is over the polygon. */
	public function isPosOverPoly():Boolean {
		return posOverPoly;
	}
